...
import br.com.geradordedevs.financialnotification.exceptions.models.ErrorObject;
import br.com.geradordedevs.financialnotification.exceptions.models.ErrorResponse;
...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> handlerException(UploadExcelException ex) {
        return ResponseEntity.status(ex.getError().getStatusCode())
                .body((new ErrorResponse(
                        Instant.now().toEpochMilli(),
                        ex.getError().getStatusCode(),
